// here in the ES module, we are exporting the named function
// for accessing these files in the index.mjs, we need to destructring the named function
...
// this is default export so there is no use of destructuring, we can direct access this in the index.mjs
// alias is used in named function export not in default export because it acts as already a alias
